...
public interface LaureateDataDao {
     ...
     *
     * @param scope Scope laureates are to be searched in, e.g. "Physics" => only query laureates who received a Physics Nobel Prize.
     * @param data  Normalized search data.
     * @return Future resolved with laureates matching the search data.
     */
    Future<List<Laureate>> searchLaureates(final String scope, final JsonObject data);
}
