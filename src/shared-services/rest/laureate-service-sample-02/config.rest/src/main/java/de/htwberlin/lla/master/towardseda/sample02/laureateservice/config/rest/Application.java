...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        final String packages = "de.htwberlin.lla.master.towardseda.sample02.laureateservice";
    ...
    private static void validateEnvVariables() {
        ...
        String err = null;
        if (System.getenv(scopeKey) == null) err = "a '" + scopeKey + "' env variable.";
        else if (System.getenv(prizeServiceHostKey) == null) {
