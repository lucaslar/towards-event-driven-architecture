...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        final String packages = "de.htwberlin.lla.master.towardseda.sample04.laureateservice";
    ...
    private static void validateEnvVariables() {
        final String scopeKey = "SCOPE";
        if (System.getenv(scopeKey) == null) {
            System.err.println("Main: Application must be started with a '" + scopeKey + "' env variable.");
            System.exit(1);
