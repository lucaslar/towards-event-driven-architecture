package de.htwberlin.lla.master.towardseda.sample04.prizeservice.prize.dao;
...
public class PrizeDataDaoImpl implements PrizeDataDao {
    ...
    @Override
    public Future<List<Prize>> searchPrizesForLaureates(final int... ids) {
    ...
    private Prize mapRow(final Row row) {
        return Prize.of(
                row.getString("title"),
